...
function js() {
  return gulp.src('./src/js/main.js')
    ...
    })).on('error', function (err) { console.error('WEBPACK ERROR', err); this.emit('end'); }) // Don't stop the rest of the task 
...
exports.watch = watch;
exports.default = gulp.series(clean, gulp.parallel(html, js, fonts, img, resources), fontsStyle, css, watch);